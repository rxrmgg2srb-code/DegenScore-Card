...
const CHALLENGE_TEMPLATES = {
  trades: {
    type: 'trades',
    title: 'Make {target} trades today',
    description: 'Complete {target} trading operations',
    targetValue: 5,
    rewardXP: 50,
  },
  winRate: {
    type: 'winRate',
    title: 'Achieve {target}% win rate',
    description: 'Reach a win rate of {target}% or more',
    targetValue: 70,
    rewardXP: 100,
  },
  volume: {
    type: 'volume',
    title: 'Trade ${target} in volume',
    description: 'Reach a total volume of ${target}',
    targetValue: 100,
    rewardXP: 75,
  },
  follows: {
    type: 'follows',
    title: 'Follow {target} new wallets',
    description: 'Follow {target} new trader wallets',
    targetValue: 3,
    rewardXP: 30,
  },
  share: {
    ...
    description: 'Share your DegenScore card on social media',
    targetValue: 1,
    rewardXP: 25,
  },
  compare: {
    type: 'compare',
    title: 'Compare {target} cards',
    description: 'Use comparison function {target} times',
    targetValue: 3,
    rewardXP: 20,
  },
  profileUpdate: {
    ...
    description: 'Customize your profile with name and bio',
    targetValue: 1,
    rewardXP: 15,
  },
};
