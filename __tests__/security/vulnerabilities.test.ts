...
describe('Security Tests: Attack Vectors', () => {
    ...
    describe('Authentication Bypass', () => {
        ...
        it('should prevent tampering with JWT', async () => {
            const token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJPbmxpbmUgSldUIEJ1aWxkZXIiLCJpYXQiOjE2MjM5MjI0NjgsImV4cCI6MTY1NTQ1ODQ2OCwiYXVkIjoid3d3LmV4YW1wbGUuY29tIiwic3ViIjoianJvY2tldEBleGFtcGxlLmNvbSIsInVzZXIiOiJhZG1pbiJ9.tampered';
    ...
    describe('Rate Limiting', () => {
        it('should block after max requests', async () => {
            const requests = Array(101).fill(null).map(() => analyzeWallet('test'));
