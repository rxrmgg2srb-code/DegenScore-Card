  ...
  it('renders report when available', () => {
    mockUseTokenSecurity.mockReturnValue({
      ...
      report: {
        ...
        liquidity: { score: 10, totalLiquiditySOL: 100, liquidityUSD: 1000, lpBurned: true, lpLocked: true, riskLevel: 'LOW' },
        holders: { score: 10, totalHolders: 100, top10HoldersPercent: 10, creatorPercent: 0, concentrationRisk: 'LOW', bundleDetected: false, bundleWallets: 0 },
        market: { score: 10, ageInDays: 10, isPumpAndDump: false },
        trading: { score: 10, bundleBots: 0, snipers: 0, washTrading: false, honeypotDetected: false, canSell: true },
        redFlags: { flags: [] },
        simulation: { buyTax: 0, sellTax: 0, transferTax: 0, maxTx: 100, maxWallet: 100 },
        contract: { isRenounced: true, isVerified: true, hasBlacklist: false, hasWhitelist: false, isProxy: false, isMintable: false },
      },
      progress: 100,
