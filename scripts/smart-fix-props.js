...
const testFiles = glob.sync('c:/Users/dscanales/Documents/DegenScore-Card/DegenScore-Card-1/__tests__/**/*.test.tsx');
...
testFiles.forEach(testFile => {
    ...
    const importMatch = content.match(/import\s+(\w+)\s+from\s+['"]@\/components\/(.*?)(?:\.tsx)?['"]/);
