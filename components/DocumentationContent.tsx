              ...
              <div className="space-y-12">
                ...
                <DocSection id="intro" title="Introduction" icon="📖">
                  <p className="text-gray-300 text-lg mb-4">
                    Welcome to <strong className="text-purple-400">DegenScore Card</strong>, the ultimate platform for analyzing,
                    gamifying, and sharing your Solana trades.
                  </p>
                  <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-6">
                    ...
                    <ul className="space-y-2 text-gray-300">
                      ...
                      <li className="flex items-start">
                        <span className="text-purple-400 mr-2">✓</span>
                        <span><strong>DegenScore</strong>: A 0-100 score that evaluates your trading skill</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-purple-400 mr-2">✓</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-purple-400 mr-2">✓</span>
                        <span><strong>Alpha Feed</strong>: See trades from the best wallets in real-time</span>
                      </li>
                    </ul>
                  </div>
                </DocSection>
                  ...
                  <div className="space-y-4">
                    ...
                    <Step number={2} title="Analyze Your Wallet">
                      ...
                      <ul className="space-y-2 text-gray-300">
                        ...
                        <li>• Calculates over 30 advanced metrics</li>
                ...
                <DocSection id="generate-card" title="Generate Your Card" icon="🎴">
                  ...
                  <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border border-purple-500/30 rounded-xl p-6 mb-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <ProcessStep>
                        <strong>4. Scoring</strong> → Your DegenScore of 0-100 is generated
                      </ProcessStep>
                      <ProcessStep>
                  ...
                  <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                    <p className="text-blue-200">
                      💡 <strong>Tip:</strong> Your card automatically updates each time you re-analyze it.
                ...
                {/* Understand Metrics */}
                <DocSection id="understand-metrics" title="Understand Metrics" icon="📊">
                  ...
                  <div className="space-y-4">
                    ...
                    <MetricCard
                      title="Win Rate"
                      range="0-100%"
                      description="Percentage of winning trades. A good win rate is >50%, but it's not the only important thing."
                    />
                    ...
                    <MetricCard
                      title="Moonshots"
                      range="0-∞"
                      description="Trades with +1000% profits (10x or more). Every degen's dream."
                    />
                ...
                <DocSection id="badges" title="Badge System" icon="🏆">
                  ...
                  <div className="space-y-4">
                    ...
                    <BadgeCategory title="🎁 Referral Badges">
                      <BadgeItem name="Influencer" description="3 paying referrals" rarity="RARE" />
                ...
                <DocSection id="daily-checkin" title="Daily Check-In" icon="🔥">
                  <p className="text-gray-300 mb-6">
                    The daily check-in system rewards you for constant engagement.
                  </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
                      <p className="text-red-200 text-sm">
                        ⚠️ <strong>Warning:</strong> If you don't check in for 24+ hours, you lose your streak and start again from 1 day.
                      </p>
                    </div>
                  </div>
                </DocSection>
                ...
                <DocSection id="challenges" title="Weekly Challenges" icon="⚔️">
                  ...
                  <div className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border-2 border-yellow-500 rounded-xl p-6 mb-6">
                    ...
                    <div className="bg-black/30 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-400 mt-1">Whoever has the most likes at the end of each week wins. Activates when 100 cards are generated.</p>
                    </div>
                  </div>
                    ...
                    <div className="bg-black/30 border border-gray-700 rounded-lg p-4 space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">Whoever has the most likes on Sunday wins 1 SOL</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <DocSection id="leaderboard" title="Leaderboard" icon="🏅">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <LeaderboardCategory
                      icon="🎯"
                      title="By DegenScore"
                      description="Ranking of best overall traders (score 0-100)"
                    />
                    <LeaderboardCategory
                      icon="💰"
                ...
                <DocSection id="faq" title="Frequently Asked Questions" icon="❓">
                  <div className="space-y-4">
                    ...
                    <FAQ
                      ...
                      answer="Yes. We only read public data from the blockchain. We never ask for your seed phrase or make transactions without your permission."
                    />
                    <FAQ
                    ...
                    <FAQ
                      ...
                      answer="You start again from 1 day. But your longest streak is saved forever in your profile."
                    />
                    <FAQ
                      question="How is the Weekly Challenge winner selected?"
                      answer="At the end of the week, we automatically verify who meets the requirements and has the best metric. The prize is sent within the next 48 hours."
                    />
                  </div>
                </DocSection>
              </div>
