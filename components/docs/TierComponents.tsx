...
export function ReferralTier({ count, title, rewards }: { count: number; title: string; rewards: string[] }) {
    return (
...
export function FeedDelayCard({ tier, delay, highlight }: { tier: string; delay: string; highlight?: boolean }) {
    return (
