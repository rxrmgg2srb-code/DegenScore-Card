  ...
  return (
    ...
    >
      ...
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="inline-block">
        <path d="M5 12h14" stroke="#05060a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M12 5l7 7-7 7" stroke="#05060a" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </a>
  );
}