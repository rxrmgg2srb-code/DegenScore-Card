        ...
        <>
            ...
            <div className="flex gap-2 mb-6">
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition ${activeTab === 'top'
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition ${activeTab === 'following'
                            ? 'bg-blue-600 text-white'
                            : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg font-medium transition ${activeTab === 'alerts'
                            ? 'bg-blue-600 text-white'
                            : 'bg-gray-800 text-gray-400 hover:bg-gray-700'
                        }`}
                >
